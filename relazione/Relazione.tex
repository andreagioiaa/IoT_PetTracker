...
\begin{abstract}
\noindent 
Il progetto Pet Tracker propone la realizzazione di un sistema IoT 
per il tracciamento in tempo reale di animali domestici di taglia media o grande, 
tramite un dispositivo embedded indossabile.
La soluzione si basa su una piattaforma
ESP32-S3 con connettività LTE e modulo GNSS, 
in grado di acquisire e trasmettere dati relativi alla posizione geografica, 
allo stato della batteria e all'attività motoria dell'animale verso un backend remoto. \\

\noindent 
L'architettura del sistema segue il modello IoT World Forum (IoTWF)
e integra diverse tecniche di ottimizzazione energetica, 
tra cui l'utilizzo della modalità Deep Sleep e di Hot Start per il GPS. 
I dati raccolti vengono elaborati dal backend, resi accessibili tramite API REST 
e visualizzati attraverso un'applicazione mobile dedicata. \\

\noindent 
L'obiettivo del progetto è sviluppare una soluzione affidabile, 
scalabile ed efficiente dal punto di vista energetico 
per il tracciamento continuo degli animali domestici.
\end{abstract}
...
\begin{itemize}
    ...
    \item \textbf{Consumo del modem LTE}: la trasmissione dati ne rappresenta la fonte principale.
    \item \textbf{Race condition sui pacchetti simultanei}: in caso di ricezione 
        ...
        nel caso di risveglio simultaneo dal \textbf{Deep Sleep}, 
