...
\texttt{r} — trip          & \texttt{q} & Animale su veicolo in movimento con allarme attivo \\
\bottomrule
\end{tabular}
...
Il \texttt{board\_id}, identificativo univoco della board LilyGo associata a uno o più dispositivi per utente,
